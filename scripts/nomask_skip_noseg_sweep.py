...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 100)
    print("GENERALIZATION SWEEP RESULTS — HEATMAP (NO MASK + SKIP) — NO SEGMENTATION")
    print("=" * 100)
    ...
    csv_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "nomask_skip_no_segmentation_results.csv")
