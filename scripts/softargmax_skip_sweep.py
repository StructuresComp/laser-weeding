...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 100)
    print("GENERALIZATION SWEEP RESULTS — SOFT-ARGMAX + SKIP CONNECTIONS")
    print("=" * 100)
    ...
    csv_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "softargmax_skip_results.csv")
